...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (id == R.id.action_add) {
                    startActivity(new Intent(MainActivity.this, AddFollowActivity.class));
                }
                return true;
            }
        });
        ...
        adapter = new FollowListAdapter(MainActivity.this, R.layout.main_list_item, dataSource);
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case 0:
                Intent intent = new Intent(MainActivity.this, AddFollowActivity.class);
